...
namespace Kabangi\Mpesa\Validation;
...
class ValueValidator
{
     ...
     *
     * @var \Kabangi\Mpesa\Validation\RuleFactory
     */
     ...
     *
     * @var \Kabangi\Mpesa\Validation\ErrorMessage
     */
     ...
     *
     * @var \Kabangi\Mpesa\Validation\RuleCollection
     */
    protected $rules;
    ...
    public function validate($value, $valueIdentifier = null, DataWrapper\WrapperInterface $context = null)
    {
        ...
        /* @var $rule \Kabangi\Mpesa\Validation\Rule\AbstractValidator */
        foreach ($this->rules as $rule) {
